...
void setup()
{
...
#ifdef LCD
  display.begin();               // start the library
  display.backlight();
  ...
  if (c == 0x71) // WHO_AM_I should always be 0x71
  {
    ...
    display.setCursor(0, 1); display.print(" x   y   z  ");
...
void loop()
{
  ...
  if (!AHRS)
  {
    ...
    if (myIMU.delt_t > 500)
    {
      ...
      display.setCursor(0,  3); display.print("Gyro T ");
      display.setCursor(8,  3); display.print(myIMU.temperature, 1);
      display.print(" C");
      display.display();
#endif // LCD
